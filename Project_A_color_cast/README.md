...
1. \*\*회색 세계 가설의 오류\*\*: 장면 평균을 무채색으로 가정하여, 화이트 밸런스하므로

특정색의 객체가 넓게 분포하거나, 컬러 캐스트와 유사한 색이 존재할 경우 \*\*과보정(Over-correction)\*\* 발생
